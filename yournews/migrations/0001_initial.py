# Generated by Django 4.2.7 on 2024-03-28 11:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follows', models.ManyToManyField(blank=True, related_name='followed_by', to='yournews.profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='yournews.news')),
            ],
            options={
                'ordering': ['created_on'],
            },
